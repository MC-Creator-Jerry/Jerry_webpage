...
//   全站累计（stats:total）已废弃：改由 stats.js 从每日 key 实时累加推导，避免每次埋点写一次 KV。
...
// 这样 /?v=20260829g 与 / 合并，/xxx/index.html?id=1 与 /xxx/?id=1 合并
...
export async function onRequestPost(context) {
  ...
  // 全站总览（stats:total）已改为由 stats.js 从每日 key 实时累加推导，
  // 不再每次埋点写一次（省 1 次 KV 写/页，直接缓解免费 1000 写/天额度压力）。
  // 此处仅做本地 PV 累加，不再维护 TOTAL_KEY。
