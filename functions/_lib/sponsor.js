...
export const TIERS = { supporter: '赞助者', pro: '小蓝页·1级成员' };
...
export async function sponsorStats(context) {
  ...
  return {
    totals: { sponsors: sponsors.length, codes: rows.length, used, unused: rows.length - used, conflicts: conflicts.length },
    sponsors,
    codes: rows,
